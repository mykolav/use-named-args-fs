...
module Expect = 
    ...
    open UseNamedArgs.Tests.Support.DiagnosticFormatter
    open UseNamedArgs.Tests.Support.DiagnosticResult
    ...
    let toMatch (analyzer: DiagnosticAnalyzer) (expected: seq<DiagResult>) (actual: seq<Diagnostic>) = 
        ...
        let expectDiagsToMatch (expected: DiagResult, actual: Diagnostic) =
            ...
            Expect.equal actual.Severity expected.Severity
